...
void FED3::UpdateDisplay() {
  ...
  display.fillRect (35, 46, 80, 68, WHITE);  //erase the pellet data on screen without clearing the entire screen zy:change from 120 to 80
