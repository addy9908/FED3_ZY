...
from tkinter import filedialog, messagebox, Listbox, END, MULTIPLE, ttk
...
# from ZY_FP_FED_wheel_V20250717_v5_20251211 import (
#     safe_read_csv, load_merge_sort, add_files_to_listbox,
#     extract_event_epochs_from_columns, plot_event_triggered_average,
#     plot_signal_with_events, analyze_signals_by_events,
#     merge_figure_dicts, save_results, save_figures, load_results,
#     fig_to_one_pdf
# )
# --------- Utilities ---------
...
class FPFEDSynchronizerGUI:
    def __init__(self, root):
        ...
        self.root.geometry("1220x1220")
        self.root.minsize(1220, 1220)
    ...
    def create_channel_mapping(self, parent):
        ...
        mapping_scrollbar.place(x=1175, y=35, width=15, height=150)
    ...
    def create_step3(self, parent):
        ...
        # Zscore_method
        tk.Label(parent, text="Zscore_method", bg='white', font=('Arial', 9)).place(
                x=265, y=10, width=155, height=25)
        self.zscore_method = ttk.Combobox(parent, values=['none', 'full', 'baseline'])
        self.zscore_method.place(x=425, y=10, width=125, height=25)
        self.zscore_method.set('full')
        
        # Limit to Available checkbox
        self.limit_available_var = tk.BooleanVar()
        tk.Checkbutton(parent, text="Limit to Available", variable=self.limit_available_var,
                      bg='white', font=('Arial', 9)).place(x=630, y=10, width=160, height=25)
    ...
    def load_and_merge(self):
        ...
        try:
            ...
            messagebox.showinfo("Success", "Files loaded and merged successfully!")
    ...
    def clean_fp_to_dff(self):
        ...
        try:
            ...
            messagebox.showinfo("Success", "FP cleaned and converted to dF/F!")
    ...
    def merge_dios_to_dff(self):
        ...
        try:
            ...
            messagebox.showinfo("Success", "DIOs merged to DFF dataframe!")
    ...
    def align_to_cno(self):
        ...
        try:
            ...
            messagebox.showinfo("Aligned", f"Aligned to CNO time at {self.cno_time:.3f}s")
    ...
    def analyze_with_mapping(self, recording_name, signal_col, event_cols, pre_time, post_time,
        ...
        for event_name, event_dict in epoch_results.items():
            if len(event_dict) > 0:
